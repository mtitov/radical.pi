...
base = 'share/%s' % name
df = [('%s/examples' % base, glob.glob('examples/[0-9]*_*.py'))]
...
setup_args = {
    ...
    'version'            : version,
    'description'        : 'The RADICAL pilot job framework (RESTful interface)',
    'author'             : 'RADICAL Group at Rutgers University',
    'author_email'       : 'radical@rutgers.edu',
    'maintainer'         : 'The RADICAL Group',
    'maintainer_email'   : 'radical@rutgers.edu',
    'url'                : 'https://www.github.com/radical-project/radical.pi/',
    'license'            : 'MIT',
    ...
    'package_dir'        : {'': 'src'},
    'scripts'            : [
                            'bin/radical-pi-start',
                            'bin/radical-pi-start.py'
                           ],
    'package_data'       : {'': ['*.txt', '*.sh', '*.json', '*.gz', '*.c',
                                 '*.md', 'VERSION', 'SDIST', sdist_name]},
    'install_requires'   : ['radical.pilot>=1.14',
                            'radical.utils>=1.14',
                            'bottle'
                           ],
